...
export class UpdateStocksComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              private dialogRef: MatDialogRef<UpdateStocksComponent>,
  ...
  ngOnInit(): void {
    this.itemDetailsForm = this.formBuilder.group({
      ...
      requested_limit: ['', Validators.required],
      main_stock: ['', Validators.required]
    });

    this.itemDetailsForm.setValue({
      mfs_id: this.data.mfs_id,
      status: this.data.status,
      // status: this.data.status,
      available_limit: this.data.available_limit,
      requested_limit: this.data.requested_limit,
      main_stock: this.data.main_stock
    });
