...
export class AuditComponent implements OnInit {
  ...
  constructor(
    ...
    private customerService: AuditService,
  ...
  public loadTable(): void {
    ...
    this.allItemSub = this.customerService.getAllAudits()
  ...
  updateCustomer(row: any): void {
    ...
    console.log(row);
    console.log('----------------------------');
    const dialogRef = this.dialog.open(UpdateAuditComponent, dialogConfig);
