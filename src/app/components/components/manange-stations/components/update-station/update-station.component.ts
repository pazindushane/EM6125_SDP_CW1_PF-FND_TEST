...
export class UpdateStationComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              private dialogRef: MatDialogRef<UpdateStationComponent>,
  ...
  ngOnInit(): void {
    this.itemDetailsForm = this.formBuilder.group({
      ...
      available_limit: ['', Validators.required],
      customer_requested_limit: ['', Validators.required],
      status: ['', Validators.required],
      station_requested_limit: ['', Validators.required],
    });
    ...
    this.itemDetailsForm.setValue({
      ...
      max_limit: this.data.max_limit,
      available_limit: this.data.available_limit,
      customer_requested_limit: this.data.customer_requested_limit,
      status: this.data.status,
      station_requested_limit: this.data.station_requested_limit,
    });
  ...
  approveDialogError4(){
    this.dialog.open(ApprovalDialogComponent, {
      width: '350px',
      // height: '200px',
      data: new ApprovalDialogConfig('Fine', 'Successfull!', 'Status Successfully Updated')
    });
  }
